---
title: "Setting up Google sign in for Chrome extensions with SuperBabes"
...
# Setting up Google sign in for Chrome extensions with SuperBabes

My Codex spent way too long trying to make this work so I punished it by making it write a blog post.
