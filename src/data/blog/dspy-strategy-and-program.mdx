...
2. **What's the thing I pass to `compile()`?** It's a module, sure. But it's the _top-level_ module, the unit of optimization. That feels distinct.
...
DSPy ships with ChainOfThought, ReAct, BestOfN, and several others. But what _are_ these things? They're not optimizers — they don't tune anything. They're not plain modules — they specifically change how LM calls happen.
...
Both strategies and optimizers exist to improve LM output. The difference is _when_ they operate:
...
A strategy changes the _mechanics_ of prediction. An optimizer changes the _content_ of prompts.
